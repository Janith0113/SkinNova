...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 pt-10">
      {/* Header */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                  <h2 className="text-xl font-bold mb-4 text-gray-800">User Growth Analytics</h2>
                  <div className="h-64 bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl flex items-center justify-center">
                    <div className="text-center">
                      <div className="text-6xl mb-4">📊</div>
                      <p className="text-gray-600 font-medium">Interactive Chart Visualization</p>
                      <p className="text-sm text-gray-400 mt-2">Showing trends over the last 30 days</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      { label: 'Add User', icon: '➕', color: 'from-green-500 to-emerald-500' },
                      { label: 'View Reports', icon: '📄', color: 'from-blue-500 to-cyan-500' },
                      { label: 'Send Email', icon: '✉️', color: 'from-purple-500 to-pink-500' },
                      { label: 'Settings', icon: '⚙️', color: 'from-orange-500 to-red-500' },
                    ].map((action, index) => (
                      <button
                        key={index}
            ...
            {activeTab === 'activity' && (
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                <h2 className="text-xl font-bold mb-6 text-gray-800">Activity Log</h2>
          ...
          <div className="space-y-6">
            {/* System Status */}
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              <h3 className="text-lg font-bold mb-4 text-gray-800">System Status</h3>
              <div className="space-y-4">
                {[
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { title: 'System backup completed', time: '1h ago', icon: '💾' },
                  { title: 'User report submitted', time: '2h ago', icon: '📝' },
                ].map((notif, index) => (
                  <div 
                    key={index}
