...
export default function TineaDetection() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-100 via-emerald-50 to-teal-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/30 backdrop-blur-xl rounded-3xl border border-white/40 shadow-2xl p-8 sm:p-12">
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-2">Tinea Detection</h1>
              ...
              {preview ? (
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="flex-1 px-6 py-3 rounded-xl bg-gradient-to-r from-yellow-600 to-amber-600 text-white font-semibold hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                    >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <button
                      onClick={() => fileInputRef.current?.click()}
                      className="p-8 border-2 border-dashed border-yellow-400 rounded-2xl hover:bg-yellow-50 transition-all group"
                    >
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg p-5">
                    <p className="text-yellow-900 font-semibold mb-2">📋 Tips for Best Results:</p>
                    <ul className="space-y-1 text-yellow-800 text-sm">
                      <li>✓ Ensure good lighting and clear visibility</li>
                      <li>✓ Focus on the ring-like patch area</li>
                ...
                <div className="space-y-4">
                  <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-2xl p-6 border-2 border-yellow-200">
                    ...
                    <p className={`text-4xl font-bold ${
                      ...
                      {result?.is_tinea ? "⚠️ Positive" : "✓ Negative"}
                    </p>
                  </div>
                          ...
                          <div className="flex items-center justify-between gap-2">
                            <div className="flex-1">
                              <div className="bg-orange-100 rounded-lg p-2 text-center">
                                <p className="text-lg font-bold text-orange-600">{result.ensembleVote.positive}</p>
                          ...
                          <div className="space-y-2">
                            <div>
                              <div className="flex justify-between items-center mb-1">
                                ...
                                <span className="text-sm font-bold text-orange-600">{result.totalPositiveCount}/60</span>
                              </div>
